...
public:
        ...
        : tf_listener_(tf_buffer_)
    {
        ...
        // Parameters
        nh.param("obstacle_height_threshold", obstacle_height_threshold_, 0.1);
    ...
    void octomapCallback(const octomap_msgs::OctomapConstPtr& msg)
    {
        try
        {
            geometry_msgs::TransformStamped transform = tf_buffer_.lookupTransform("base_link", msg->header.frame_id, ros::Time(0));
        ...
        {
            ROS_WARN("Failed to transform octomap: %s", ex.what());
        }
    }
